...
if (!parentPageId) {
  throw new Error("Usage: node scripts/create-notion-db.mjs <parent-page-id>");
}
...
const properties = {
  ...
  "한 줄 요약": { rich_text: {} },
  "핵심 왜 굳이 질문": { rich_text: {} },
  "비즈니스 관찰기 각도": { rich_text: {} },
  "소비자 행동 관점": { rich_text: {} },
  "기존 글과의 연결": { rich_text: {} },
...
const response = await fetch("https://api.notion.com/v1/databases", {
  ...
  body: JSON.stringify({
    ...
    title: [{ type: "text", text: { content: "LinkedIn Signal Scout" } }],
    properties
  })
});
