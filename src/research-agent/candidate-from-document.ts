...
function rawItemFromDocument(
  ...
  return {
    ...
    collectorType: document.collectorType ?? document.documentType,
    ...
    country: document.country ?? "UNKNOWN",
    sourceCategory: document.sourceCategory ?? "manual",
    sourceReliability: document.reliabilityTier,
    collectedAt: document.collectedAt ?? document.fetchedAt,
    entityName,
    entityType,
